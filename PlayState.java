...
public class PlayState extends GameState {
	...
	// spaceshipparts
	private ArrayList<ToBeSaved> spaceshipparts;
	...
	public void init() {
		...
		// create lists
		spaceshipparts = new ArrayList<ToBeSaved>();
	...
	private void populateItems() {
		...
		if(Content.getItemMap() == ""){ //sets the items to the map
			placeItem(Item.KEY, 26, 37);
			placeItem(Item.MASK, 12, 4);
		}else{
		String currLine;
	...
	public void update() {
		...
		for(int i = 0; i < spaceshipparts.size(); i++) {
			...
			ToBeSaved d = spaceshipparts.get(i);
			d.update();
	...
	public void draw(Graphics2D g) {
		...
		// draw spaceshipparts
		for(ToBeSaved d : spaceshipparts) {
			d.draw(g);
		}
