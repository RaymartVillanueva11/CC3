...
public class GameOverState extends GameState {
	...
	public void draw(Graphics2D g) {
		...
		if(rank == 1) Content.drawString(g, "Diamond", 45, 78);
		else if(rank == 2) Content.drawString(g, "Platinum", 45, 78);
		else if(rank == 3) Content.drawString(g, "Gold", 45, 78);
		else if(rank == 4) Content.drawString(g, "Noob", 45, 78);
